...
describe("daily practice UI", () => {
  ...
  it("wires the new pages and Grade 5 summary mount", () => {
    ...
    assert.match(grade, /src\/daily-practice\.css\?v=20260826-(?:grade-parity[12]|global2|wide1|streak-ready1|notebook-scroll1|notebook-tabs1)/);
  ...
  it("mounts the animated mistake notebook on Grade 4", () => {
    ...
    assert.match(grade, /src\/daily-practice\.css\?v=20260826-(?:grade-parity[12]|global2|notebook-tabs1)/);
    assert.match(grade, /data-notebook-shortcut/);
